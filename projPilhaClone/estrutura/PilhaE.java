...
public class PilhaE implements Cloneable{
	...
	public PilhaE clone() throws CloneNotSupportedException{
		PilhaE pilhaClonada = (PilhaE) super.clone(); //força a ser PilhaE porque o super.clone() retorna Object.
		pilhaClonada.itens=this.itens.clone(); //clone do Eletronico
		for (int i=0; i<this.getTamanhoMax(); i++){
